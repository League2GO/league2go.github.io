...
category: players
order: 20
description: "Your schedule, declaring absences, accepting substitution requests, and managing your profile."
---
This guide covers your day-to-day as a player: checking your schedule, declaring an absence, accepting a substitution request, and keeping your profile up to date.
...
* If a substitute has already accepted your spot and your plans change, contact your league manager. <!-- TODO: verify whether a player can cancel an absence once a substitute has accepted -->
...
Your profile is yours: once you have registered, only you can edit it — not your league manager. From your profile you can:
...
To leave a league, ask your league manager to remove you from the roster, or use the leave-league option in your profile. <!-- TODO: verify the self-serve leave-league option --> Leaving a league does not delete your League2GO account — you keep access to your other leagues.
