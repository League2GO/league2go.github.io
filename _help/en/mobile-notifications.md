---
title: "Mobile notifications (push)"
lang: en
localization: mobile-notifications
category: players
order: 40
description: "Set up push notifications on your phone and fix them when they stop working."
---
This guide describes **how to get started** with mobile push notifications and provides helpful **troubleshooting tips** to help you resolve common issues.

## Push notifications

Mobile push notifications offer you the best experience, and are a great way to never miss a game. Since they are even faster than SMS, you will have a better chance of getting the available space in the next game you want to play.
...
Once you have your League2GO account, download our app
...
<br/>
<div class="image-container-row">
{% include image.html src="2023-01-29-mobile-notifications-activate-ios-en.png" caption="Setup notifications screen" %}
{% include image.html src="2023-01-29-mobile-notifications-activate-android-en.png" caption="Setup notifications screen" %}
</div>
<br/>
...
<br/>
<br/>
* **Do you have do not disturb on?** Do you have scheduled digests on? Add the League2GO app as an exception.
<br/>
<br/>
* **Did you log out?** You need to stay logged in to receive push notifications for your account.
<br/>
<br/>
* **Do you have wifi or data turned on?** You need to stay connected to the internet. If you are disconnected you will receive push notifications when you reconnect.
<br/>
<br/>

### I received the email "Your mobile notifications no longer work"

If you received an email from us informing you that your push notifications no longer work, open the app and look for "diagnose push notifications" at the top of the menu.
...
As a last resort, uninstall and re-install the League2GO app. At login, activate push notifications, and you will receive a confirmation push notification on your device.
