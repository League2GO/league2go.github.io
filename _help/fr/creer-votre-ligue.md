---
title: "Créer votre ligue"
lang: fr
localization: create-your-league
category: getting-started
order: 10
description: "Configurez votre ligue de A à Z : compte, équipes, joueurs, remplaçants et calendrier."
redirect_from:
  - /enregistrer-sa-ligue-en-5-etapes/
  - /commencer-avec-maligueca/
  - /commencer-avec-league2go/
  - /gere-comme-un-pro/
---

Ce guide vous accompagne dans la mise en place de votre ligue sur League2GO, de la création de votre compte jusqu'à vos premières parties. Chaque étape renvoie à un article détaillé si vous voulez aller plus loin.

## 1. Créer votre compte

Allez sur [league2go.com](https://league2go.com/?lang=fr#/signup) et entrez l'information demandée. Un seul compte suffit pour être gestionnaire ou joueur de plusieurs ligues. Consultez [votre compte](/votre-compte/) pour comprendre le fonctionnement des comptes et de la connexion.

## 2. Créer votre ligue

Les ligues se créent **sur le site web** [league2go.com](https://league2go.com), pas dans l'application mobile.
