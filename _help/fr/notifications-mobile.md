---
title: "Notifications mobiles (push)"
lang: fr
localization: mobile-notifications
category: players
order: 40
description: "Activez les notifications push sur votre téléphone et réparez-les lorsqu'elles cessent de fonctionner."
---
Ce guide décrit **comment commencer** avec les notifications mobiles et fournit des **conseils de dépannage** utiles pour vous aider à résoudre des problèmes.

## Notifications push

Les notifications mobiles (push) vous offrent la meilleure expérience et sont un excellent moyen de ne jamais manquer une partie. Comme elles sont plus rapides que les SMS, vous aurez plus de chances d'obtenir l'espace disponible lors de la prochaine partie à laquelle vous souhaitez jouer.
...
* **Envoyez un push test** via votre profil (voir ci-dessous)
<br/>
<br/>
...
2. Naviguez vers le bas de la page et cherchez « Envoyer un push »
...
<br/>
<div class="image-container-row">
{% include image.html src="2023-01-29-mobile-notifications-profile-ios-fr.png" caption="Profil" %}
{% include image.html src="2023-01-29-mobile-notifications-test-ios-fr.png" caption="Recevoir un push test" %}
</div>
<br/>
