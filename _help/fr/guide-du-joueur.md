...
lang: fr
localization: player-guide
category: players
order: 20
description: "Votre horaire, déclarer une absence, accepter une demande de remplacement et gérer votre profil."
---
Ce guide couvre votre quotidien de joueur : consulter votre horaire, déclarer une absence, accepter une demande de remplacement et garder votre profil à jour.
...
* Si un remplaçant a déjà accepté votre place et que vos plans changent, contactez votre gestionnaire de ligue. <!-- TODO: verify whether a player can cancel an absence once a substitute has accepted -->
...
Votre profil vous appartient : une fois inscrit, vous seul pouvez le modifier, pas votre gestionnaire de ligue. Depuis votre profil, vous pouvez :
...
Pour quitter une ligue, demandez à votre gestionnaire de ligue de vous retirer de l'alignement, ou utilisez l'option pour quitter la ligue dans votre profil. <!-- TODO: verify the self-serve leave-league option --> Quitter une ligue ne supprime pas votre compte League2GO : vous gardez l'accès à vos autres ligues.
