...
category: managers
order: 80
description: "Regroupez vos équipes en divisions ou en conférences et affichez le classement par division."
---

Les divisions (ou conférences) permettent de regrouper les équipes d'une ligue à l'intérieur d'une saison. Elles sont utiles pour les grandes ligues où les équipes s'affrontent dans des groupes distincts tout en partageant un même calendrier et une même ligue League2GO.

Les divisions sont **optionnelles** — si votre ligue ne les utilise pas, vous pouvez ignorer cette page.

## Assigner les équipes aux divisions
...
* [Saisons](/saisons/)
* [Équipes et paramètres d'équipe](/equipes-et-parametres/)
* [Résultats, classement et statistiques](/resultats-classement-statistiques/)
